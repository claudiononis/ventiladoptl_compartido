                ...
                oModel.read("/ZVENTILADO_KPISet", {
                    ...
                    success: function (oData) {
                        if (oData.results && oData.results.length > 0) {
                            ...
                            const roll = parseInt(localStorage.getItem("conteoROLL"), 10) || 0;
                            const pallet = parseInt(localStorage.getItem("conteoPALLET"), 10) || 0;
                            var totalTot =
                ...
                oModel.read("/ZVENTILADO_KPISet", {
                    ...
                    success: function (oData) {
                        if (oData.results && oData.results.length > 0) {
                            ...
                            var sDuracionfinal = Math.floor((parseODataDurationToMilliseconds(sODataHoraActual) -
                                registro.Iniciodesafectacion.ms) / 60000
                            );
                            ...
                            var oUpdate = [
                                {
                                   ...
                                   Tiempobruto: Math.floor(
                                    ...
                                    Tiempoproductivo: registro.Duracionpreparacion + registro.Duracionneta + sDuracionfinal
