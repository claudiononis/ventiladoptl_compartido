        ...
        var oDialogPassword = new sap.m.Dialog({
          ...
          beginButton: new sap.m.Button({
            ...
            press: function () {
              ...
              var oModelo = new sap.ui.model.odata.v2.ODataModel(
              ...
              oModelo.read("/ZCONFIGVENTILADOSet", {
                ...
                success: function (oResponse) {
                  if (oResponse.results[0].Passadm1 == sPassword) {
                    // Validar la contraseña con la respuesta del backend
                    ...
                    var oDialogEdit = new sap.m.Dialog({
                      ...
                      beginButton: new sap.m.Button({
                        ...
                        press: function () {
                          ...
                          var tTableData =
                            oLocalModel.getProperty("/tableData");
                          var registro = tTableData.find(
                            (item) => item.Id === oData.Id
                          );
                          ...
                          if (registro) {
                            ...
                            M3r =
                              (registro.M3v * Number(updatedValue)) /
                              registro.cantidadAsig;
                            Kgbrr =
                              (registro.Kgbrv * Number(updatedValue)) /
                              registro.cantidadAsig;

                            var resultadoFormateadoM3r = M3r.toFixed(
                              3
                            ).padStart(5, " ");
                            var resultadoFormateadoKgbrr = Kgbrr.toFixed(
                              2
                            ).padStart(5, " ");
                ...
                error: function () {
                  sap.m.MessageToast.show(
                    "Error al validar la contraseña en el servidor."
                  );
                },
              });
            },
          ...
          beginButton: new sap.m.Button({
            ...
            press: function () {
              ...
              oModelo.read("/ZCONFIGVENTILADOSet", {
                ...
                success: function (oResponse) {
                  if (oResponse.results[0].Passadm1 == sPassword) {
                    // Suponiendo que el backend devuelve un campo IsValid
                    oDialog.close();
                ...
                error: function () {
                  sap.m.MessageToast.show(
                    "Error al validar la contrasena en el servidor."
                  );
                },
              });
            },
