		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ventiladoventiladoptl-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ventiladoventiladoptl-display": {
								"semanticObject": "ventiladoventiladoptl",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ventilado.ventiladoptl",
									"url": sap.ui.require.toUrl("ventilado/ventiladoptl")
								}
							}
						}
					}
